...
set CommonLinkerFlags= -incremental:no -opt:ref /FORCE:MULTIPLE tmx_impl.obj raylib.lib user32.lib gdi32.lib winmm.lib shell32.lib kernel32.lib msvcrt.lib /NODEFAULTLIB:LIBCMT
